...
import cl.emendare.cleancodegenerator.domain.contract.GenerateDeleteContractInterface;
 ...
 */
public class GenerateDeleteContract implements GenerateDeleteContractInterface {
    ...
    public String generate (
        ...
        ciWriter.sendLine("Generating code for Delete" + name + "Interface.java");
        ...
        Method addMethod = mf.create("delete", "public", entity);
        addMethod.setReturnType("boolean"); 
        ...
        ciWriter.sendLine("Code for Delete" + name + "Interface.java generated");
